...
app_server <- function( input, output, session ) {
  ...
  mod_predictions_unlabelled_data_server(
    ...
    pipe_path = "C:\\Users\\andreas.soteriades\\Documents\\git_projects\\pxtextmining\\results_label\\pipeline_label.sav"
  )
  ...
  mod_predictions_unlabelled_data_server(
    ...
    preds_column = "predictions",
    column_names = c("feedback", "organization"),
    pipe_path = "C:\\Users\\andreas.soteriades\\Documents\\git_projects\\pxtextmining\\results_criticality\\pipeline_criticality.sav"
  )
